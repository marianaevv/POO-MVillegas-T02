...
public class POOEmpresaAgroalimentaria {
    ...
    public static void main(String[] args) {
        ...
        Productos alimento = new Productos ("12 de julio del 2016",540);
        ...
        System.out.println("Esta es la informacion de los Productos");
        System.out.println("Fecha de caducidad: " + alimento.getFecha());
        System.out.println ("Numero de lote: "+ alimento.getLote());
        System.out.println("");
        ...
        System.out.println("Informacion para los productos congelados por Aire");
        System.out.println("El equipo utilizado para congelar por aire es: "+ fresas.getEquipoCongelacion());
        System.out.println("");
        System.out.println("Informacion para los productos congelados por Agua");
        System.out.println("La cantidad de liquido dentro del fruto es: " +moras.getCantidadliquido() + "ml" );
        System.out.println("");
        System.out.println("Informacion para los productos congelados con Nitrogeno");
